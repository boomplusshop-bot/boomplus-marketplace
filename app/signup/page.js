      ...
      <div style={{maxWidth: "440px", width: "100%"}}>
        ...
        <div style={{background: "white", borderRadius: "16px", border: "1px solid #e5e7eb", padding: "2.5rem 2rem", boxShadow: "0 4px 20px rgba(0,0,0,0.08)"}}>
          ...
          <p style={{color: "#4b5563", marginBottom: "2rem", textAlign: "center", fontSize: "0.95rem"}}>
            เริ่มต้นใช้งาน Boom Plus Marketplace
          </p>
        ...
        <p style={{textAlign: "center", fontSize: "0.8rem", color: "#6b7280", marginTop: "1.5rem", lineHeight: "1.6"}}>
          การสมัครสมาชิกแสดงว่าคุณยอมรับ
          <br />
          <Link href="/terms" style={{color: "#4b5563", textDecoration: "underline", fontWeight: "500"}}>
            ข้อกำหนด
          </Link>
          {" และ "}
          <Link href="/privacy" style={{color: "#4b5563", textDecoration: "underline", fontWeight: "500"}}>
